...
public class SendEdit : IStanzaRequest
{
    ...
    {
        var ns = Group ? Namespaces.CHAT_GROUP_EDIT : Namespaces.CHAT_EDIT;

        var body = X.C("body", null, [], Content);
        var item = X.C("item", null, [("id", MessageId)], body);
